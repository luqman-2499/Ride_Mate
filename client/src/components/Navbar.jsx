...
const Navbar = () => {
    ...
    // Close mobile menu when resizing to desktop breakpoint (Tailwind sm: 640px)
    useEffect(() => {
        const handleResize = () => {
    ...
    return (
        ...
        <motion.div
            ...
            className={`flex items-center justify-between px-6 md:px-16 lg:px-24 x1:px-32 py-4 text-gray-600 border-b border-borderColor relative transition-all ${location.pathname === "/" && "bg-light"}`}>
