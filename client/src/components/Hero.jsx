...
const handleSearch = (e) => {
  ...
  return (
    ...
    <motion.h1 initial = {{y: 50, opacity: 0}}
        ...
        className='text-4xl md:text-5xl mt-30 font-semibold'> Luxury Cars For Rent</motion.h1>
    ...
    whileTap={{scale: 0.95}} 
    className=' flex items-center justify-center gap-1 px-9 py-3 max-sm:empty-4 bg-primary hover:bg-primary-dull text-white rounded-full cursor-pointer'>
        <img src={assets.search_icon} alt="search" className="birghtness-300" />
        Search
    </motion.button>
