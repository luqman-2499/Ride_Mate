...
const MyBookings = () => {
  ...
  const {axio, user, currency} = useAppContext()
 ...
 user &&  fetchMyBookings()
  ...
  return (
    ...
    className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 mt-16 text-sm max-w-7xl'>
      ...
      <Title title= 'My Bookings' subTitle= 'View and amange your Bookings' align='left' />
        <div>
          {
                  ...
                  <div className='md:col-span-2'>
                    <div className='flex items-center gap-2'>
                      <p className='px-3 py-1. bg-light rounded'>Booking #{index+1}</p>
                        <p className={`px-3 py-1 test-xs rounded-full ${booking.status === 'confirmed' ? 
