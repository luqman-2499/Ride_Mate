...
const handleSubmit = async (e) => {
  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <button onClick = {()=> navigate(-1)} className='flex items-center gap-2 mt-6 text-gray-500 cursor-pointer'> 
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        transition={{duration: 0.6}}
         className='lg:col-span-2'>
          ...
          src={car.image} alt="" className='w-full h-auto md:max-h-100 object-cover rounded-xl shadow-md' />
                  ...
                  {[
                    ...
                    <div>
                      ...
                      <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                        {
                          ["360 camera", "Bluetooth", "GPS", "Rear View Mirror"].map((item)=>(
